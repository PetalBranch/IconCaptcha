...
/**
 * IconSet 类实现了 IconSetInterface 接口，用于管理和获取图标集。
 *
 * 该类提供了一个构造函数来初始化字体文件路径，并且提供了一个静态方法 getIcons 来获取图标名称及其对应的 Unicode 值。
 */
class IconSet implements IconSetInterface
{
     ...
     * @throws Exception
     */
    public function __construct($FontFilePath)
    {
        if (!file_exists($FontFilePath)) {
            throw new Exception("Font file not found. Checked: $FontFilePath");
        }
